...
## Corpus Check
- 172 files · ~79,907 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1729 nodes · 3293 edges · 111 communities (85 shown, 26 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 234 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `483e2dae`
...
Cohesion: 0.07
Nodes (20): DiscordStreamNotifyBot.SharedService.Twitcasting, DiscordStreamNotifyBot.DataBase.Table, BannerChange, DateTime, DbEntity, GuildConfig, GuildYoutubeMemberConfig, NoticeTwitcastingStreamChannel (+12 more)

### Community 1 - "YouTube Stream Commands"
Cohesion: 0.08
Nodes (25): CancellationToken, IDatabase, int, StreamEntry, Task, TimeSpan, TwitcastingService, TwitchService (+17 more)
...
Cohesion: 0.09
Nodes (34): ChannelInfo, ClusterQueryType, GuildSnapshot, IReadOnlyCollection, Replies, Responses, SocketGuild, DiscordSocketClient (+26 more)
...
Cohesion: 0.24
Nodes (6): GeneratedRegex, DbSet, MainDbContext, Regex, YTChannelType, YoutubeDetectionService

### Community 11 - "Embed Builder Factory"
Cohesion: 0.13
Nodes (11): DateTime, EmbedBuilder, YTApiVideo, EmbedBuilderFactory, HoloVideos, NijisanjiVideos, NonApprovedVideos, OtherVideos (+3 more)

### Community 12 - "Scaling Architecture Docs"
Cohesion: 0.19
Nodes (6): DiscordStreamNotifyBot.SharedService, DiscordStreamNotifyBot.DataBase, DiscordStreamNotifyBot.Interaction, BotPlayingStatus, NoticeType, YTNotificationType
...
Cohesion: 0.17
Nodes (6): DiscordStreamNotifyBot.HttpClients, DiscordStreamNotifyBot.SharedService.Youtube, DiscordStreamNotifyBot.Scraper, DiscordStreamNotifyBot.Shared, DiscordStreamNotifyBot, DiscordStreamNotifyBot.Scraper.Detection.Twitcasting

### Community 22 - "YouTube Reminder Scheduler"
Cohesion: 0.16
Nodes (9): ConsoleColor, LogMessage, LogType, Exception, object, string, Task, Log (+1 more)
...
Cohesion: 0.11
Nodes (13): HttpException, DateTime, Func, List, object, TimeSpan, NoticeCache, EmbedBuilder (+5 more)

### Community 31 - "Cluster Leader/Heartbeat"
Cohesion: 0.06
Nodes (30): Counter, DiscordStreamNotifyBot.Coordinator, Gauge, HashSet, StreamGroupInfo, string, CoordinatorMetrics, CancellationToken (+22 more)
...
Cohesion: 0.14
Nodes (15): SendMsgToAllGuildService, DefaultMemberPermissions, RequireOwner, SlashCommand, Task, SendMsgToAllGuild, CommandExample, CommandSummary (+7 more)

### Community 41 - "YouTube Member Interaction"
Cohesion: 0.25
Nodes (11): DiscordStreamNotifyBot.Command.YoutubeMember, ICommandService, Alias, Command, RequireContext, RequireOwner, Summary, Task (+3 more)
...
Cohesion: 0.08
Nodes (25): ButtonCheckData, DiscordStreamNotifyBot.Interaction.OwnerOnly.Service, SendAllPayload, bool, DiscordSocketClient, Embed, ButtonCheckData, NoticeType (+17 more)
...
Cohesion: 0.08
Nodes (21): DiscordStreamNotifyBot.Command.Help, IEqualityComparer, Func, CommonEqualityComparer, Alias, Command, CommandInfo, CommandService (+13 more)
...
Cohesion: 0.33
Nodes (5): Dictionary, ChannelInfo, ClusterQueryType, GuildInfoResponse, GuildSnapshot
...
Cohesion: 0.40
Nodes (3): DiscordStreamNotifyBot.SharedService.YoutubeMember, DiscordStreamNotifyBot.Interaction.YoutubeMember, YoutubeMemberService
...
Cohesion: 0.06
Nodes (36): DiscordStreamNotifyBot.HttpClients.Twitcasting.Model, DiscordStreamNotifyBot.Command.TwitCasting, Alias, Command, RequireContext, RequireOwner, Task, TwitCasting (+28 more)

### Community 64 - "YouTube Autocomplete"
Cohesion: 0.12
Nodes (12): DiscordStreamNotifyBot.Scraper.Detection.Youtube, DiscordStreamNotifyBot.Scraper.Detection.Twitch, DiscordStreamNotifyBot.SharedService.Twitch, DiscordStreamNotifyBot.SharedService.Youtube.Json, DiscordStreamNotifyBot.Shared.Messages, NoticeType, NowStreamingHost, ConnectionMultiplexer (+4 more)
...
Cohesion: 0.08
Nodes (21): DiscordStreamNotifyBot.Command, IDisposable, ModuleBase, SocketMessage, CommandService, DiscordSocketClient, IServiceProvider, Task (+13 more)
...
Cohesion: 0.14
Nodes (10): DebouncedEventArgs, RedisValue, ConcurrentDictionary, HashSet, Task, TwitchDetectionService, Task, YoutubeDetectionService (+2 more)
...
Cohesion: 0.24
Nodes (5): DateTime, RecordYoutubeChannel, DateTime, YTChannelType, YoutubeChannelOwnedType

### Community 258 - "DiscordSocketClient"
Cohesion: 0.28
...
- **Why does `DiscordStreamNotifyBot.DataBase` connect `Scaling Architecture Docs` to `Admin Broadcast Commands`, `YouTube Autocomplete`, `YouTube Member Commands`, `Twitcasting Categories JSON`, `YouTube Member Interaction`, `EF Migrations`, `Twitcasting Webhook Models`, `Nijisanji Stream JSON`, `20250603065853_ModifyTwitCastingTable.Designer.cs`, `20250620094111_AddMaxSpiderCountSettingField.Designer.cs`, `20260709091318_AddManualMemberCheckVideoFlag.Designer.cs`, `Bot Entry Points`, `Uptime Kuma Client`, `SyncModelDrift`, `Twitcasting Channel Info`, `IUserMessage`, `Command Attributes`, `Twitch Autocomplete`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `MainDbService` connect `Twitcasting Channel Info` to `YouTube Stream Commands`, `Twitch Commands`, `Twitcasting Service & DbContext`, `Notification Bus Consumer`, `TwitcastingDetectionService`, `Command Help Module`, `YouTube Slash Commands`, `Bot Startup & Membership`, `Command/Interaction Modules`, `YouTube Member Service`, `Logging`, `Member Check Settings`, `Twitcasting Detection`, `Twitcasting Commands`, `YouTube Member Interaction`, `Twitch Spider Commands`, `Nijisanji Stream JSON`, `Scraper Service`, `Twitch Autocomplete`, `YouTube Autocomplete`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `DiscordStreamNotifyBot.Shared` connect `Bot Entry Points` to `YouTube Autocomplete`, `YouTube Stream Commands`, `Bot State & Timers`, `Coordinator Entry/Shutdown`, `Coordinator Service`, `Scaling Architecture Docs`, `Redis Channels`, `Nijisanji Stream JSON`, `YouTube Channel Spider`, `Uptime Kuma Client`, `Command Attributes`, `Cluster Leader/Heartbeat`?**
